...
/**
 * @Class Name : SujileeDAO.java
 * @Description : Sujilee DAO Class
...
@Repository("sujileeDAO")
public class SujileeDAO extends EgovComAbstractDAO {
	...
	public String insertSujilee(SujileeVO vo) throws Exception {
		return  insert("sujileeDAO.insertSujilee", vo)+"";
	}
	...
	public void updateSujilee(SujileeVO vo) throws Exception {
		update("sujileeDAO.updateSujilee", vo);
	}
	...
	public void deleteSujilee(SujileeVO vo) throws Exception {
		delete("sujileeDAO.deleteSujilee", vo);
	}
	...
	public SujileeVO selectSujilee(SujileeVO vo) throws Exception {
		return (SujileeVO) selectOne("sujileeDAO.selectSujilee", vo);
	}
	...
	public List<?> selectSujileeList(SujileeDefaultVO searchVO) throws Exception {
		return list("sujileeDAO.selectSujileeList", searchVO);
	}
	...
	public int selectSujileeListTotCnt(SujileeDefaultVO searchVO) {
		return (Integer) selectOne("sujileeDAO.selectSujileeListTotCnt", searchVO);
	}
