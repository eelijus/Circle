...
<%
  /**
  * @Class Name : egovSujileeList.jsp
  * @Description : Sujilee List 화면
...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/js/egovframework/sujilee/sujilee.js'/>" ></script>
<%--     <script type="text/javascript" src="<c:url value='/js/egovframework/sujilee/sujileeRegister.js'/>" ></script> --%>
    ...
    function fn_egov_select(id) {
    	document.listForm.selectedId.value = id;
       	document.listForm.action = "<c:url value='/updateSujileeView.do'/>";
    ...
    function fn_egov_addView() {
    	...
    	document.listForm.action = "<c:url value='/addSujileeView.do'/>";
       	document.listForm.submit();
    }
    
    /* 글 목록 화면 function */
    function fn_egov_selectList() {
    	document.listForm.action = "<c:url value='/egovSujileeList.do'/>";
       	document.listForm.submit();
    }
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div id="title">
        		<ul>
        			<li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>" alt=""/>sujilee리스트</li>
        		</ul>
        	</div>
        	<!-- // 타이틀 --> 
        	<div id="SearchArea">
        	  ...
        	  <ul>
        	      <li>
        	          <span id = "btnCreate" class="btn_blue_l">
        	              <a href="javascript:fn_egov_addView();">신규 등록</a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
              </ul>
